...
typedef volatile struct {
    uint32_t bt_select;                               /* 0x0 */
    uint32_t out;                                     /* 0x4 */
    uint32_t out_w1ts;                                /* 0x8 */
    uint32_t out_w1tc;                                /* 0xc */
    union {                                           /* 0x10 */
        struct {
            uint32_t data:      22;
    ...
    uint32_t enable_w1ts;                             /* 0x24 */
    uint32_t enable_w1tc;                             /* 0x28 */
    union {                                           /* 0x2c */
        struct {
            uint32_t data:       22;
            uint32_t reserved22: 10;
...
int main()
{
    uint32_t offset = offsetof(gpio_dev_t, in);
	printf("offsetof: %d (0x%x)\r\n", offset, offset); 
}
